...
def test_primary_documented_routes_exist_in_app_surface() -> None:
    ...
    documented_routes = {
        ...
        ("POST", "/api/v1/shares"),
        ("GET", "/api/v1/shares/{share_euid}"),
        ("POST", "/api/v1/shares/{share_euid}/access-package"),
        ("POST", "/api/v1/shares/{share_euid}/revoke"),
        ("GET", "/api/v1/shares/{share_euid}/audit"),
        ("GET", "/api/v1/artifacts/{artifact_euid}/shares"),
